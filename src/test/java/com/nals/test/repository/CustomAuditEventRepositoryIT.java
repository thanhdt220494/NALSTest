package com.nals.test.repository;

import com.nals.test.NalsTestApp;
import com.nals.test.config.Constants;
import com.nals.test.config.audit.AuditEventConverter;
import com.nals.test.domain.PersistentAuditEvent;
...
import static com.nals.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
